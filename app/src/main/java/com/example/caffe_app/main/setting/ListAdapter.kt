package com.example.caffe_app.basic_listview
...
import com.example.caffe_app.main.setting.ListModel
...
class ListAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        val view = convertView?: LayoutInflater.from(context).inflate(R.layout.list_setting, parent,false)
